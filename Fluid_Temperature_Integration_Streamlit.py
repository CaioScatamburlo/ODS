...
# === Pump Data ===
st.header("Pump Data")
# Removido pump_heat_factor como input e fixado em 1.0
...
if st.button("Run Simulation"):
    ...
    # Calculate pump shaft power from hydraulic power and efficiency
    # This is the expected nominal power if efficiency is correctly given for hydraulic power
    if pump_eff > 0: # Avoid division by zero
    ...
    if calib_pump_eff > 0: # Avoid division by zero
    ...
    # dWp_dt now uses pump_power_kw (shaft power) directly as the total heat generated,
    # based on our discussion that 100% of shaft power converts to heat in a closed system.
    ...
    if t_110_h is not None:
        ...
        dWp_dt_calib = calib_pump_power_kw * 1000 * calib_num_pumps  # Adjusted for pump_heat_factor = 1.0
