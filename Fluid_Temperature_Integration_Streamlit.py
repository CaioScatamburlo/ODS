...
# NOVO INPUT PARA A ÁREA DA BOMBA
...
# NOVO INPUT PARA A ÁREA DA BOMBA DE CALIBRAÇÃO (se for diferente)
# Assumindo que a área da bomba de calibração é a mesma da bomba de aquecimento para simplicidade
# Se precisar de um input separado, adicione calib_pump_surface_area_m2 aqui
